...
import 'package:wekala_user/firebase_options.dart';
import 'package:wekala_user/helper/address_helper.dart';
import 'package:wekala_user/helper/auth_helper.dart';
import 'package:wekala_user/helper/link_converter_helper.dart';
import 'package:wekala_user/helper/notification_helper.dart';
import 'package:wekala_user/helper/responsive_helper.dart';
import 'package:wekala_user/helper/route_helper.dart';
import 'package:wekala_user/theme/dark_theme.dart';
import 'package:wekala_user/theme/light_theme.dart';
import 'package:wekala_user/util/app_constants.dart';
import 'package:wekala_user/util/messages.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'package:flutter/material.dart';
import 'package:flutter_local_notifications/flutter_local_notifications.dart';
import 'package:get/get.dart';
import 'package:wekala_user/features/home/widgets/cookies_view.dart';
                ...
                return (GetPlatform.isWeb &&
                    ...
                    : GetMaterialApp(
                        ...
                        routingCallback: (routing) {
                          if (routing == null ||
                              (routing.isBottomSheet ?? false) ||
                              (routing.isDialog ?? false))
                            return;
                          if (Get.isRegistered<ProController>()) {
                            Get.find<ProController>().maybeShowRenewOnRoute(
                              routing.current,
                            );
                          }
                        },
