...
import 'package:wekala_user/features/auth/domain/models/signup_body_model.dart';
...
class AuthRepository implements AuthRepositoryInterface {
    ...
    if (alreadyInApp &&
      ...
      try {
        isRideOrService =
            ...
            (ModuleHelper.getModule()!.moduleType.toString() ==
                    AppConstants.ride ||
                ModuleHelper.getModule()!.moduleType.toString() ==
      ...
      apiClient.updateHeader(
        ...
        ModuleHelper.getModule()?.id?.toString(),
        addressModel.latitude,
        addressModel.longitude, //null, addressModel.zoneId,
        addressModel.zoneId,
        fromModule: isRideOrService,
      );
    } else {
      apiClient.updateHeader(
        token,
  ...
  Future<void> saveOtpUserNumber(String number, String countryCode) async {
    ...
    await sharedPreferences.setString(
      AppConstants.otpUserCountryCode,
      countryCode,
    );
  }
