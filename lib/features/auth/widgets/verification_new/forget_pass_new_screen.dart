...
import 'package:wekala_user/features/verification/screens/verification_screen.dart';
...
class _ForgetPassNewScreenState extends State<ForgetPassNewScreen> {
  ...
  bool isEmail = false;
  bool isPhone = false;
  RecoveryMethod recoveryMethod = RecoveryMethod.phone;
  ...
  void initState() {
    ...
    // print('isPhone: $isPhone, isEmail: $isEmail');
...
void dispose() {
      ...
      body: SafeArea(
        child: Align(
          ...
          child: Container(
            ...
            margin: context.width > 700 && !widget.fromDialog
                ? const EdgeInsets.all(50)
                : EdgeInsets.zero,
                  ...
                  (isPhone || isEmail)
                      ? Column(
                          ...
                          children: [
                            Text(
                              isPhoneUse()
                                  ? 'use_mail_phone_for_recovery'.tr
                                  : 'use_mail_mail_for_recovery'.tr,
                            ...
                            Text(
                              isPhoneUse()
                                  ? 'please_enter_registered_phone'.tr
                                  : 'please_enter_registered_email'.tr,
  ...
  bool isPhoneUse() => recoveryMethod == RecoveryMethod.phone;
}
