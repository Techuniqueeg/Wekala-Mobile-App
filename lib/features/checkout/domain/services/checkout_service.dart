...
class CheckoutService implements CheckoutServiceInterface {
  ...
  Future<SurgePriceModel?> getSurgePrice({
    ...
    return await checkoutRepositoryInterface.getSurgePrice(
      zoneId: zoneId,
      moduleId: moduleId,
      dateTime: dateTime,
      guestId: guestId,
  ...
  @override
  Future<Response> storeSavedPrescriptionImages(
    List<MultipartBody> images,
  ) async {
    return await checkoutRepositoryInterface.storeSavedPrescriptionImages(
      images,
    );
  }
