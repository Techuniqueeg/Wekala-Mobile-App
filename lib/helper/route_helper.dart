...
import 'package:wekala_user/common/widgets/custom_loader.dart';
import 'package:wekala_user/common/widgets/custom_snackbar.dart';
import 'package:wekala_user/common/widgets/image_viewer_screen.dart';
import 'package:wekala_user/common/widgets/not_found.dart';
import 'package:wekala_user/common/widgets/zone_warning_dialog.dart';
import 'package:wekala_user/features/address/domain/models/address_model.dart';
import 'package:wekala_user/features/address/screens/add_address_screen.dart';
import 'package:wekala_user/features/address/screens/address_screen.dart';
import 'package:wekala_user/features/ai_chat_bot/screens/ai_chat_bot_screen.dart';
import 'package:wekala_user/features/ai_chat_bot/screens/ai_chat_details_screen.dart';
import 'package:wekala_user/features/auth/controllers/auth_controller.dart';
import 'package:wekala_user/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:wekala_user/features/auth/screens/new_user_setup_screen.dart';
import 'package:wekala_user/features/auth/screens/rider_registration_screen.dart';
import 'package:wekala_user/features/auth/screens/store_registration_screen.dart';
import 'package:wekala_user/features/brands/screens/brands_product_screen.dart';
import 'package:wekala_user/features/brands/screens/brands_screen.dart';
import 'package:wekala_user/features/business/screens/subscription_payment_screen.dart';
import 'package:wekala_user/features/pro/screens/subscription_plan_screen.dart';
import 'package:wekala_user/features/business/screens/subscription_success_or_failed_screen.dart';
...
import 'package:wekala_user/features/category/screens/category_item_screen.dart';
import 'package:wekala_user/features/category/screens/category_screen.dart';
import 'package:wekala_user/features/chat/domain/models/conversation_model.dart';
import 'package:wekala_user/features/chat/domain/models/order_chat_model.dart';
import 'package:wekala_user/features/chat/screens/chat_screen.dart';
import 'package:wekala_user/features/chat/screens/conversation_screen.dart';
import 'package:wekala_user/features/checkout/screens/checkout_screen.dart';
import 'package:wekala_user/features/checkout/screens/digital_payment_failed_screen.dart';
import 'package:wekala_user/features/checkout/screens/order_successful_screen.dart';
import 'package:wekala_user/features/coupon/screens/coupon_screen.dart';
...
import 'package:wekala_user/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:wekala_user/features/home/screens/home_screen.dart';
import 'package:wekala_user/features/html/screens/html_viewer_screen.dart';
import 'package:wekala_user/features/interest/screens/interest_screen.dart';
...
import 'package:wekala_user/features/item/screens/item_campaign_screen.dart';
import 'package:wekala_user/features/item/screens/item_view_all_screen.dart';
import 'package:wekala_user/features/item/screens/popular_item_screen.dart';
import 'package:wekala_user/features/language/controllers/language_controller.dart';
import 'package:wekala_user/features/location/screens/access_location_screen.dart';
import 'package:wekala_user/features/location/screens/map_screen.dart';
import 'package:wekala_user/features/location/screens/pick_map_screen.dart';
import 'package:wekala_user/features/loyalty/screens/loyalty_screen.dart';
import 'package:wekala_user/features/notification/domain/models/notification_body_model.dart';
import 'package:wekala_user/features/notification/screens/notification_screen.dart';
import 'package:wekala_user/features/order/domain/models/order_model.dart';
import 'package:wekala_user/features/order/screens/guest_track_order_screen.dart';
import 'package:wekala_user/features/order/screens/order_screen.dart';
import 'package:wekala_user/features/order/screens/order_tracking_screen.dart';
import 'package:wekala_user/features/order/screens/refund_request_screen.dart';
import 'package:wekala_user/features/parcel/domain/models/parcel_category_model.dart';
import 'package:wekala_user/features/parcel/screens/parcel_category_screen.dart';
import 'package:wekala_user/features/rental_module/rental_cart_screen/rental_cart_screen.dart';
import 'package:wekala_user/features/ride_share_module/ride_location/screens/map_screen.dart' as ride_map;
import 'package:wekala_user/features/service_module/common/models/service_provider_model.dart';
import 'package:wekala_user/features/service_module/provider_details/screens/provider_details_screen.dart';
import 'package:wekala_user/features/service_module/service_category_screen/screens/service_category_screen.dart';
import 'package:wekala_user/features/rental_module/vendor/screens/provider_detail_screen.dart';
import 'package:wekala_user/features/service_module/service_details/screens/service_details_screen.dart';
import 'package:wekala_user/features/service_module/service_home/domain/models/service_category_model.dart';
import 'package:wekala_user/features/parcel/screens/parcel_location_screen.dart';
import 'package:wekala_user/features/parcel/screens/parcel_request_screen.dart';
import 'package:wekala_user/features/payment/screens/offline_payment_screen.dart';
import 'package:wekala_user/features/payment/screens/payment_screen.dart';
import 'package:wekala_user/features/payment/screens/payment_webview_screen.dart';
...
import 'package:wekala_user/features/profile/screens/setting_page.dart';
import 'package:wekala_user/features/profile/screens/update_profile_screen.dart';
import 'package:wekala_user/features/auth/screens/sign_in_screen.dart';
import 'package:wekala_user/features/auth/screens/sign_up_screen.dart';
import 'package:wekala_user/features/auth/widgets/verification_new/forget_pass_new_screen.dart';
import 'package:wekala_user/features/auth/widgets/verification_new/new_pass_new_screen.dart';
import 'package:wekala_user/features/auth/widgets/verification_new/verification_new_screen.dart';
import 'package:wekala_user/features/redesign_feature/dashboard/widgets/common_widget/item_details_new_screen.dart';
import 'package:wekala_user/features/language/screens/language_new_screen.dart';
import 'package:wekala_user/features/onboard/screens/onboarding_new_screen.dart';
import 'package:wekala_user/features/order/screens/order_details_new_screen.dart';
import 'package:wekala_user/features/ride_share_module/safety_alert/screens/safety_policy_screen.dart';
import 'package:wekala_user/features/search/screens/search_screen.dart';
import 'package:wekala_user/features/store/screens/store_screen.dart';
import 'package:wekala_user/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:wekala_user/features/review/screens/review_screen.dart';
import 'package:wekala_user/features/splash/controllers/splash_controller.dart';
import 'package:wekala_user/features/splash/screens/qr_screen.dart';
import 'package:wekala_user/features/splash/screens/splash_screen.dart';
import 'package:wekala_user/features/store/domain/models/store_model.dart';
import 'package:wekala_user/features/store/screens/all_store_screen.dart';
import 'package:wekala_user/features/store/screens/campaign_screen.dart';
import 'package:wekala_user/features/store/screens/store_item_search_screen.dart';
import 'package:wekala_user/features/store/widgets/all_store_web_view_widget.dart';
import 'package:wekala_user/features/service_module/custom_service_request/screens/custom_service_details_screen.dart';
import 'package:wekala_user/features/service_module/request_service/screens/requested_service_screen.dart';
import 'package:wekala_user/features/service_module/request_service/screens/new_service_request_screen.dart';
import 'package:wekala_user/features/service_module/service_checkout/screens/service_checkout_screen.dart';
import 'package:wekala_user/features/service_module/custom_service_request/screens/custom_service_list_screen.dart';
import 'package:wekala_user/features/service_module/custom_service_request/screens/custom_service_request_screen.dart';
import 'package:wekala_user/features/support/screens/support_screen.dart';
import 'package:wekala_user/features/update/screens/update_screen.dart';
import 'package:wekala_user/features/wallet/screens/wallet_screen.dart';
import 'package:wekala_user/helper/address_helper.dart';
import 'package:wekala_user/helper/auth_helper.dart';
import 'package:wekala_user/helper/maintance_helper.dart';
import 'package:wekala_user/helper/module_helper.dart';
import 'package:wekala_user/helper/shallow_route_helper.dart';
