...
import 'package:wekala_user/features/address/domain/repositories/address_repository.dart';
import 'package:wekala_user/features/address/domain/repositories/address_repository_interface.dart';
import 'package:wekala_user/features/address/domain/services/address_service.dart';
import 'package:wekala_user/features/address/domain/services/address_service_interface.dart';
import 'package:wekala_user/features/ai_chat_bot/controllers/ai_chat_bot_controller.dart';
import 'package:wekala_user/features/ai_chat_bot/domain/repositories/ai_chat_bot_repository.dart';
import 'package:wekala_user/features/ai_chat_bot/domain/repositories/ai_chat_bot_repository_interface.dart';
import 'package:wekala_user/features/ai_chat_bot/domain/services/ai_chat_bot_service.dart';
...
import 'package:wekala_user/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:wekala_user/features/auth/controllers/store_registration_controller.dart';
import 'package:wekala_user/features/auth/domain/reposotories/auth_repository.dart';
import 'package:wekala_user/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:wekala_user/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:wekala_user/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:wekala_user/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:wekala_user/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:wekala_user/features/auth/domain/services/auth_service.dart';
import 'package:wekala_user/features/auth/domain/services/auth_service_interface.dart';
import 'package:wekala_user/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:wekala_user/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:wekala_user/features/auth/domain/services/store_registration_service.dart';
...
import 'package:wekala_user/features/banner/domain/repositories/banner_repository.dart';
import 'package:wekala_user/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:wekala_user/features/banner/domain/services/banner_service.dart';
import 'package:wekala_user/features/banner/domain/services/banner_service_interface.dart';
import 'package:wekala_user/features/brands/controllers/brands_controller.dart';
import 'package:wekala_user/features/brands/domain/repositories/brands_repository.dart';
import 'package:wekala_user/features/brands/domain/repositories/brands_repository_interface.dart';
import 'package:wekala_user/features/brands/domain/services/brands_service.dart';
import 'package:wekala_user/features/brands/domain/services/brands_service_interface.dart';
import 'package:wekala_user/features/business/controllers/business_controller.dart';
import 'package:wekala_user/features/business/domain/repositories/business_repo.dart';
import 'package:wekala_user/features/business/domain/repositories/business_repo_interface.dart';
import 'package:wekala_user/features/business/domain/services/business_service.dart';
import 'package:wekala_user/features/business/domain/services/business_service_interface.dart';
import 'package:wekala_user/features/cart/controllers/cart_controller.dart';
import 'package:wekala_user/features/cart/domain/repositories/cart_repository.dart';
import 'package:wekala_user/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:wekala_user/features/cart/domain/services/cart_service.dart';
import 'package:wekala_user/features/cart/domain/services/cart_service_interface.dart';
import 'package:wekala_user/features/category/controllers/category_controller.dart';
import 'package:wekala_user/features/category/domain/reposotories/category_repository.dart';
import 'package:wekala_user/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:wekala_user/features/category/domain/services/category_service.dart';
...
import 'package:wekala_user/features/chat/domain/repositories/chat_repository.dart';
import 'package:wekala_user/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:wekala_user/features/chat/domain/services/chat_service.dart';
...
import 'package:wekala_user/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:wekala_user/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:wekala_user/features/checkout/domain/services/checkout_service.dart';
import 'package:wekala_user/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:wekala_user/features/coupon/controllers/coupon_controller.dart';
import 'package:wekala_user/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:wekala_user/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:wekala_user/features/coupon/domain/services/coupon_service.dart';
import 'package:wekala_user/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:wekala_user/features/favourite/controllers/favourite_controller.dart';
import 'package:wekala_user/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:wekala_user/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:wekala_user/features/favourite/domain/services/favourite_service.dart';
import 'package:wekala_user/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:wekala_user/features/flash_sale/controllers/flash_sale_controller.dart';
import 'package:wekala_user/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:wekala_user/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:wekala_user/features/flash_sale/domain/services/flash_sale_service.dart';
import 'package:wekala_user/features/flash_sale/domain/services/flash_sale_service_interface.dart';
import 'package:wekala_user/features/home/controllers/advertisement_controller.dart';
import 'package:wekala_user/features/home/controllers/home_controller.dart';
import 'package:wekala_user/features/home/domain/repositories/advertisement_repository.dart';
import 'package:wekala_user/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:wekala_user/features/home/domain/repositories/home_repository.dart';
import 'package:wekala_user/features/home/domain/repositories/home_repository_interface.dart';
import 'package:wekala_user/features/home/domain/services/advertisement_service.dart';
import 'package:wekala_user/features/home/domain/services/advertisement_service_interface.dart';
import 'package:wekala_user/features/home/domain/services/home_service.dart';
import 'package:wekala_user/features/home/domain/services/home_service_interface.dart';
import 'package:wekala_user/features/html/controllers/html_controller.dart';
import 'package:wekala_user/features/html/domain/repositories/html_repository.dart';
import 'package:wekala_user/features/html/domain/repositories/html_repository_interface.dart';
import 'package:wekala_user/features/html/domain/services/html_service.dart';
import 'package:wekala_user/features/html/domain/services/html_service_interface.dart';
...
import 'package:wekala_user/features/item/domain/repositories/campaign_repository.dart';
import 'package:wekala_user/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:wekala_user/features/item/domain/repositories/item_repository.dart';
import 'package:wekala_user/features/item/domain/repositories/item_repository_interface.dart';
import 'package:wekala_user/features/item/domain/services/campaign_service.dart';
import 'package:wekala_user/features/item/domain/services/campaign_service_interface.dart';
import 'package:wekala_user/features/item/domain/services/item_service.dart';
import 'package:wekala_user/features/item/domain/services/item_service_interface.dart';
...
import 'package:wekala_user/features/language/domain/repository/language_repository.dart';
import 'package:wekala_user/features/language/domain/repository/language_repository_interface.dart';
import 'package:wekala_user/features/language/domain/service/language_service.dart';
...
import 'package:wekala_user/features/location/domain/repositories/location_repository.dart';
import 'package:wekala_user/features/location/domain/repositories/location_repository_interface.dart';
import 'package:wekala_user/features/location/domain/services/location_service.dart';
import 'package:wekala_user/features/location/domain/services/location_service_interface.dart';
import 'package:wekala_user/features/loyalty/controllers/loyalty_controller.dart';
import 'package:wekala_user/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:wekala_user/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:wekala_user/features/loyalty/domain/services/loyalty_service.dart';
import 'package:wekala_user/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:wekala_user/features/notification/controllers/notification_controller.dart';
import 'package:wekala_user/features/notification/domain/repository/notification_repository.dart';
import 'package:wekala_user/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:wekala_user/features/notification/domain/service/notification_service.dart';
import 'package:wekala_user/features/notification/domain/service/notification_service_interface.dart';
...
import 'package:wekala_user/features/onboard/domain/service/onboard_service_interface.dart';
import 'package:wekala_user/features/order/controllers/order_controller.dart';
import 'package:wekala_user/features/order/domain/repositories/order_repository.dart';
import 'package:wekala_user/features/order/domain/repositories/order_repository_interface.dart';
import 'package:wekala_user/features/order/domain/services/order_service.dart';
...
import 'package:wekala_user/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:wekala_user/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:wekala_user/features/parcel/domain/services/parcel_service.dart';
import 'package:wekala_user/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:wekala_user/features/payment/controllers/payment_controller.dart';
import 'package:wekala_user/features/payment/domain/repositories/payement_repository.dart';
import 'package:wekala_user/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:wekala_user/features/payment/domain/services/payment_service.dart';
import 'package:wekala_user/features/payment/domain/services/payment_service_interface.dart';
import 'package:wekala_user/features/pro/controllers/pro_controller.dart';
import 'package:wekala_user/features/pro/domain/repositories/pro_repository.dart';
import 'package:wekala_user/features/pro/domain/repositories/pro_repository_interface.dart';
import 'package:wekala_user/features/pro/domain/services/pro_service.dart';
...
import 'package:wekala_user/features/profile/domain/repositories/profile_repository.dart';
import 'package:wekala_user/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:wekala_user/features/profile/domain/services/profile_service.dart';
import 'package:wekala_user/features/profile/domain/services/profile_service_interface.dart';
import 'package:wekala_user/features/offer/controllers/offer_controller.dart';
import 'package:wekala_user/features/offer/domain/repositories/offer_repository.dart';
import 'package:wekala_user/features/offer/domain/repositories/offer_repository_interface.dart';
import 'package:wekala_user/features/offer/domain/services/offer_service.dart';
import 'package:wekala_user/features/offer/domain/services/offer_service_interface.dart';
import 'package:wekala_user/features/rental_module/vendor/controllers/verified_provider_controller.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/repositories/verified_provider_repository.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/repositories/verified_provider_repository_interface.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/services/verified_provider_service.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/services/verified_provider_service_interface.dart';
import 'package:wekala_user/features/service_module/service_details/controllers/service_details_controller.dart';
import 'package:wekala_user/features/service_module/service_details/domain/repositories/service_details_repository.dart';
...
import 'package:wekala_user/features/service_module/service_details/domain/services/service_details_service.dart';
import 'package:wekala_user/features/service_module/service_details/domain/services/service_details_service_interface.dart';
import 'package:wekala_user/features/service_module/provider_details/controllers/provider_data_controller.dart';
import 'package:wekala_user/features/service_module/service_category_screen/controllers/service_category_controller.dart';
import 'package:wekala_user/features/service_module/provider_details/domain/repositories/provider_details_repository.dart';
import 'package:wekala_user/features/service_module/provider_details/domain/repositories/provider_details_repository_interface.dart';
import 'package:wekala_user/features/service_module/provider_details/domain/services/provider_details_service.dart';
import 'package:wekala_user/features/service_module/provider_details/domain/services/provider_details_service_interface.dart';
import 'package:wekala_user/features/service_module/service_home/controllers/service_controller.dart';
import 'package:wekala_user/features/service_module/service_home/controllers/service_explore_controller.dart';
import 'package:wekala_user/features/service_module/service_home/controllers/service_verified_provider_controller.dart';
import 'package:wekala_user/features/service_module/service_home/domain/repositories/service_repository.dart';
import 'package:wekala_user/features/service_module/service_home/domain/repositories/service_repository_interface.dart';
import 'package:wekala_user/features/service_module/service_home/domain/services/service_service.dart';
import 'package:wekala_user/features/service_module/service_home/domain/services/service_service_interface.dart';
import 'package:wekala_user/features/ride_share_module/common/controllers/map_controller.dart';
import 'package:wekala_user/features/ride_share_module/ride_home/controllers/rideHome_controller.dart';
import 'package:wekala_user/features/ride_share_module/ride_home/domain/repositories/rideHome_repository.dart';
import 'package:wekala_user/features/ride_share_module/ride_home/domain/repositories/rideHome_repository_interface.dart';
import 'package:wekala_user/features/ride_share_module/ride_home/domain/services/rideHome_service.dart';
import 'package:wekala_user/features/ride_share_module/ride_home/domain/services/rideHome_service_interface.dart';
import 'package:wekala_user/features/ride_share_module/ride_location/controllers/search_location_controller.dart';
import 'package:wekala_user/features/ride_share_module/ride_location/domain/repositories/search_location_repository.dart';
import 'package:wekala_user/features/ride_share_module/ride_location/domain/repositories/search_location_repository_interface.dart';
import 'package:wekala_user/features/ride_share_module/ride_location/domain/services/search_location_service.dart';
import 'package:wekala_user/features/ride_share_module/ride_location/domain/services/search_location_service_interface.dart';
import 'package:wekala_user/features/ride_share_module/ride_order/controllers/ride_controller.dart';
import 'package:wekala_user/features/ride_share_module/ride_order/domain/repositories/ride_order_repository.dart';
import 'package:wekala_user/features/ride_share_module/ride_order/domain/repositories/ride_order_repository_interface.dart';
import 'package:wekala_user/features/ride_share_module/ride_order/domain/services/ride_order_service.dart';
import 'package:wekala_user/features/ride_share_module/ride_order/domain/services/ride_order_service_interface.dart';
import 'package:wekala_user/features/ride_share_module/ride_payment/controllers/ride_payment_controller.dart';
import 'package:wekala_user/features/ride_share_module/ride_payment/domain/repositories/ride_payment_repository.dart';
import 'package:wekala_user/features/ride_share_module/ride_payment/domain/repositories/ride_payment_repository_interface.dart';
import 'package:wekala_user/features/ride_share_module/ride_payment/domain/services/ride_payment_service.dart';
import 'package:wekala_user/features/ride_share_module/ride_payment/domain/services/ride_payment_service_interface.dart';
import 'package:wekala_user/features/ride_share_module/safety_alert/controllers/safety_alert_controller.dart';
import 'package:wekala_user/features/ride_share_module/safety_alert/domain/repositories/safety_alert_repository.dart';
import 'package:wekala_user/features/ride_share_module/safety_alert/domain/repositories/safety_alert_repository_interface.dart';
import 'package:wekala_user/features/ride_share_module/safety_alert/domain/services/safety_alert_service.dart';
import 'package:wekala_user/features/ride_share_module/safety_alert/domain/services/safety_alert_service_interface.dart';
import 'package:wekala_user/features/ride_share_module/trip/controllers/trip_controller.dart';
import 'package:wekala_user/features/ride_share_module/trip/domain/repositories/trip_repository.dart';
import 'package:wekala_user/features/ride_share_module/trip/domain/repositories/trip_repository_interface.dart';
import 'package:wekala_user/features/ride_share_module/trip/domain/services/trip_service.dart';
import 'package:wekala_user/features/ride_share_module/trip/domain/services/trip_service_interface.dart';
import 'package:wekala_user/features/search/controllers/search_controller.dart';
import 'package:wekala_user/features/search/domain/repositories/search_repository.dart';
import 'package:wekala_user/features/search/domain/repositories/search_repository_interface.dart';
import 'package:wekala_user/features/search/domain/services/search_service.dart';
import 'package:wekala_user/features/search/domain/services/search_service_interface.dart';
import 'package:wekala_user/features/reels/controllers/reels_controller.dart';
import 'package:wekala_user/features/reels/domain/repositories/reels_repository.dart';
import 'package:wekala_user/features/reels/domain/repositories/reels_repository_interface.dart';
import 'package:wekala_user/features/reels/domain/services/reels_service.dart';
import 'package:wekala_user/features/reels/domain/services/reels_service_interface.dart';
import 'package:wekala_user/features/rental_module/home/controllers/taxi_home_controller.dart';
import 'package:wekala_user/features/rental_module/home/domain/repositories/taxi_home_repository.dart';
import 'package:wekala_user/features/rental_module/home/domain/repositories/taxi_home_repository_interface.dart';
import 'package:wekala_user/features/rental_module/home/domain/services/taxi_home_service.dart';
...
import 'package:wekala_user/features/rental_module/rental_cart_screen/domain/repository/taxi_cart_repository.dart';
...
import 'package:wekala_user/features/rental_module/rental_cart_screen/domain/services/taxi_cart_service.dart';
import 'package:wekala_user/features/rental_module/rental_cart_screen/domain/services/taxi_cart_service_interface.dart';
import 'package:wekala_user/features/rental_module/rental_favourite/controllers/taxi_favourite_controller.dart';
import 'package:wekala_user/features/rental_module/rental_favourite/domain/repositories/taxi_favourite_repository.dart';
import 'package:wekala_user/features/rental_module/rental_favourite/domain/repositories/taxi_favourite_repository_interface.dart';
import 'package:wekala_user/features/rental_module/rental_favourite/domain/services/taxi_favourite_service.dart';
import 'package:wekala_user/features/rental_module/rental_favourite/domain/services/taxi_favourite_service_interface.dart';
import 'package:wekala_user/features/rental_module/rental_location_screen/controller/taxi_location_controller.dart';
import 'package:wekala_user/features/rental_module/rental_location_screen/domain/repository/taxi_repository.dart';
import 'package:wekala_user/features/rental_module/rental_location_screen/domain/repository/taxi_repository_interface.dart';
import 'package:wekala_user/features/rental_module/rental_location_screen/domain/services/taxi_location_service.dart';
import 'package:wekala_user/features/rental_module/rental_location_screen/domain/services/taxi_location_service_interface.dart';
import 'package:wekala_user/features/rental_module/rental_order/controllers/taxi_order_controller.dart';
import 'package:wekala_user/features/rental_module/rental_order/domain/repository/taxi_order_repository.dart';
import 'package:wekala_user/features/rental_module/rental_order/domain/repository/taxi_order_repository_interface.dart';
import 'package:wekala_user/features/rental_module/rental_order/domain/services/taxi_order_service.dart';
import 'package:wekala_user/features/rental_module/rental_order/domain/services/taxi_order_service_interface.dart';
import 'package:wekala_user/features/rental_module/vendor/controllers/taxi_vendor_controller.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/repositories/taxi_vendor_repository.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/repositories/taxi_vendor_repository_interface.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/services/taxi_vendor_service.dart';
import 'package:wekala_user/features/rental_module/vendor/domain/services/taxi_vendor_service_interface.dart';
import 'package:wekala_user/features/review/controllers/review_controller.dart';
import 'package:wekala_user/features/review/domain/repositories/review_repository.dart';
import 'package:wekala_user/features/review/domain/repositories/review_repository_interface.dart';
import 'package:wekala_user/features/review/domain/services/review_service.dart';
import 'package:wekala_user/features/review/domain/services/review_service_interface.dart';
import 'package:wekala_user/features/smart_banner/controllers/smart_banner_controller.dart';
import 'package:wekala_user/features/smart_banner/domain/repositories/smart_banner_repository.dart';
import 'package:wekala_user/features/smart_banner/domain/repositories/smart_banner_repository_interface.dart';
import 'package:wekala_user/features/smart_banner/domain/services/smart_banner_service.dart';
...
import 'package:wekala_user/features/splash/domain/repositories/splash_repository.dart';
import 'package:wekala_user/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:wekala_user/features/splash/domain/services/splash_service.dart';
import 'package:wekala_user/features/splash/domain/services/splash_service_interface.dart';
import 'package:wekala_user/features/store/controllers/store_controller.dart';
import 'package:wekala_user/features/store/domain/repositories/store_repository.dart';
import 'package:wekala_user/features/store/domain/repositories/store_repository_interface.dart';
import 'package:wekala_user/features/store/domain/services/store_service.dart';
import 'package:wekala_user/features/store/domain/services/store_service_interface.dart';
import 'package:wekala_user/features/verification/controllers/verification_controller.dart';
import 'package:wekala_user/features/verification/domein/reposotories/verification_repository.dart';
import 'package:wekala_user/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:wekala_user/features/verification/domein/services/verification_service.dart';
import 'package:wekala_user/features/verification/domein/services/verification_service_interface.dart';
import 'package:wekala_user/features/wallet/controllers/wallet_controller.dart';
import 'package:wekala_user/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:wekala_user/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:wekala_user/features/wallet/domain/services/wallet_service.dart';
import 'package:wekala_user/features/wallet/domain/services/wallet_service_interface.dart';
